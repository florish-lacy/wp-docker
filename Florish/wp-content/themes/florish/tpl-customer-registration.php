                     ...
                     <div class="row">
                        ...
                        <div class="col-lg-12 col-md-12 col-12" id="location_div">
                           <div class="input-fld">
                              ...
                              <input type="hidden" placeholder="" name="user_location_lat" id="user_location_lat" class="form-control" >
                              <input type="hidden" placeholder="" name="user_location_long" id="user_location_long" class="form-control" >
                           </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-12">
                           <div class="input-fld">
                              <label class="up-lbl">Password</label>
                              <input type="password" name="password" id="password"  value="" class="form-control password" required="" class="form-control">
                        ...
                        <div class="col-lg-12 col-md-12 col-12">
                           <div class="input-fld">
                              ...
                              <input type="password" name="confirm_password" id="confirm_password"  value="" class="form-control" required="" class="form-control">
                           </div>
                        </div>
                        <div class="col-lg-12 col-md-12 col-12">
                           <div class="btn-fld">
