<?php /* Template Name: Nursery Landing */ ?>
...
<div class="nursery-landing">
	...
	<div class="px-4 pt-5 my-5 text-center border-bottom">
		<h1 class="col-lg-8 mx-auto display-4 fw-bold text-body-emphasis">Where Nurture Meets Innovation in Your Nursery!</h1>
	...
	<div class="container px-4 py-5">
		<h2 class="pb-2 border-bottom">Benefit Statements</h2>
		...
		<div class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-4 py-5">
			<div class="col d-flex align-items-start">
				...
				<div>
					<h3 class="fw-bold mb-0 fs-4 text-body-emphasis">Increase Sales</h3>
			...
			<div class="col d-flex align-items-start">
				...
				<div>
					<h3 class="fw-bold mb-0 fs-4 text-body-emphasis">Generate Passive Revenue</h3>
			...
			<div class="col d-flex align-items-start">
				...
				<div>
					<h3 class="fw-bold mb-0 fs-4 text-body-emphasis">Waste less Time</h3>
			...
			<div class="col d-flex align-items-start">
				...
				<div>
					<h3 class="fw-bold mb-0 fs-4 text-body-emphasis">No Marketing Costs</h3>
			...
			<div class="col d-flex align-items-start">
				...
				<div>
					<h3 class="fw-bold mb-0 fs-4 text-body-emphasis">Ensure Customer Success</h3>
