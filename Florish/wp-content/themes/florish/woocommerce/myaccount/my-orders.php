...
if ( $customer_orders ) : ?>
	...
	<table class="shop_table shop_table_responsive table my_account_orders">
							...
							<?php elseif ( 'order-actions' === $column_id ) : ?>
								...
								if ( ! empty( $actions ) ) {
									foreach ( $actions as $key => $action ) { // phpcs:ignore WordPress.WP.GlobalVariablesOverride.Prohibited
										...
										echo '<button type="button" class="btn btn-primary view_nur_qty" data-orderid="'.$order->get_id().'" data-bs-toggle="modal" data-bs-target="#exampleModal1">View</button>';
										}
									}
								}
								?>
