...
$cfg['blowfish_secret']					= 'DX`!j_Tg`=BY,V=F;6-\\/t#tt+60=9[3' ;  // i.e. '$b~`lnkwm>^^jNUEE;(4xB$L\'b?."\'o9' 
...
$cfg['PmaAbsoluteUri'] 					= '/wp-content/plugins/wp-phpmyadmin-extension/lib/phpMyAdmin_waQz8FU0KdiolryxNBXqMh5/';			//used, if different directory by htaccess ; or parse_url($GLOBALS['PMA_PHP_SELF']);
...
$cfg['Servers'][$i]['SignonURL']    = 'https://florishstaging.ideatosteer.com/wp-admin/?rand=1402642&goto_wp_phpmyadmin=1';
$cfg['Servers'][$i]['LogoutURL']    = 'https://florishstaging.ideatosteer.com/wp-admin/?rand=82719069&pma_logout=1';
