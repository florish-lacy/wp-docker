<?php
// Todo: PHP Warning:  Undefined variable $tax_query in /var/www/html/wp-content/themes/florish/front-page.php on line 217
get_header(); ?>
	...
	<div class="container">
		<div class="bnr-innr">
			<div class="txt-pnl">
				...
				<div class="bnr-btn">
					<a class="cmn-btn" href="<?php echo wc_get_page_permalink('shop') ?>">
...
<section class="hm-featured cmn-gap">
	<div class="container">
		<div class="title-pnl">
			<h2 class="cs-mb">
				<?php the_field('featured_categories_title'); ?>
			</h2>
		</div>
		<div class="row">
			<?php
					...
					<div class="<?php echo $col_num; ?>">
						<div class="box">
							...
							<div class="content">
								...
								<a href="<?php echo esc_url($term_link); ?>"> <img
		...
		<div class="row">
			...
			<div class="col-lg-6 col-md-6 col-12 p-0">
				<div class="text-block">
					<h2 class="cs-mb">
						<?php the_field('create_your_own_title'); ?>
					</h2>
					<p>
						<?php the_field('create_your_own_details'); ?>
					</p>
...
<section class="hm-product cmn-gap">
	<div class="container">
		<div class="title-pnl">
			<div class="lt-side">
				<h2>
					<?php the_field('new_products_title'); ?>
				</h2>
			</div>
			<div class="rt-side">
						...
						<div class="box">
							...
							<div class="text">
								<div class="title">
									...
									<span class="price">
										<?php if ($sale_price) { ?>
											<?php echo wc_price($sale_price); ?> <del>
								...
								<div class="cart">
									<a href="<?php echo wc_get_cart_url() . '?add-to-cart=' . get_the_ID(); ?>"><img
											src="<?php echo get_template_directory_uri(); ?>/assets/images/wcart.svg" alt="" /></a>
								</div>
							</div>
						</div>
					</div>
