                                 ...
                                 <div class="row">
                                    ...
                                    <div class="col-md-6 col-sm-12">
                                       <div class="form-group">
                                          ...
                                          <input id="ein_name" type="text"
                                             name="ein_name" class="form-control"
                                             placeholder="EIN" >
                                       </div>
                                    </div>
                                    <div class="col-md-6 col-sm-12">
                                 ...
                                 <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                       <div class="form-group delivery-miles-distance">
                                          <label for="manager_delivery_radius_1"><strong>Delivery Distance</strong> </label>
                                          <p>Select delivery distance for this location and accept prices</p>
                                          <div class="select_miles"><strong><span class="miles-number">5</span> Miles</strong></div>
                                          <div class="input-range">
                                             <span>0</span><input id="manager_delivery_radius_1" type="range"
                                                name="manager_delivery_radius_1" min="0" max="15" value="5" class="change-delivery-radious"
                                             ...
                                             <div class="accordion-content">
                                                <ul class="select-days">
                                                   ...
                                                   <label for="delivery_days_saturday_morning">Morning</label>
                                                         <input class=""
                                                            name="delivery_days_saturday_morning" id="delivery_days_saturday_morning" type="checkbox"
                                                            value="Morning" required>
                                                   </li>
                                                   <li>
                                                   <label for="delivery_days_saturday_afternoon">Afternoon</label>
                                                         <input class=""
                                                            name="delivery_days_saturday_afternoon" id="delivery_days_saturday_afternoon" type="checkbox"
                                                            value="Afternoon" required>
                                                   </li>
                                                   <li>
                                                   <label for="delivery_days_saturday_evening">Evening</label>
                                                         <input class=""
                                                            name="delivery_days_saturday_evening" id="delivery_days_saturday_evening" type="checkbox"
                                                            value="Evening" required>
                                                   </li>
                                                </ul>
                                             </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-12 col-sm-12">
                                       <div class="form-group upload-insurance">
                                          <input class="box__file form-control" type="file" name="files" id="file" data-multiple-caption="{count} files selected" />
                                          <label for="file"><i class="fa-solid fa-arrow-up-from-bracket"></i><strong>Click to upload</strong><span class="box__dragndrop"> or drag and drop</span>.</label>
                                       </div>
                                    </div>
                                    <div class="col-md-12 col-sm-12">
                                      <ul class="acflch_box">
                                    ...
                                    <div class="col-md-12 col-sm-12">
                                       ...
                                       <ul class="acflch_box">
                                          <li> <label for="insurance_file_caption"><a href="<?php echo esc_url( get_page_link( 1576 ) ); ?>" target="_blank"><u>Vendor Agreement</u></a> - read and sign</label></li>
                                          <li><label for="insurance_file_caption"><a href="<?php echo esc_url( get_page_link( 3 ) ); ?>" target="_blank"><u>Privacy Policy</u></a> - read and sign</label></li>
                                       </ul>
                                       <ul class="acflch_box">
                                          <li><input class="" name="" id="" type="checkbox" value="Yes" /> I agree to update inventory as soon as it sells out</li>
                                          <li><input class="" name="" id="" type="checkbox" value="Yes" /> I agree to claim orders by the end of the business day they are received</li>
                                          <li><input class="" name="" id="" type="checkbox" value="Yes" /> I agree to deliver within 5 days of claiming order</li>
                                       </ul>
                                       <label><strong>Accept Florish Service Fee</strong></label>
                                       <ul class="acflch_box">
                                          <li><input class="" name="" id="" type="checkbox" value="Yes" /> Florish charges a nursery service fee of X% in your market</li>
                                          <li><input class="" name="" id="" type="checkbox" value="Yes" /> I accept checkbox</li>
                                       </ul>
                                    </div>
                                 </div>
                              </div>
