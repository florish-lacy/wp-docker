...
class GF_Installation_Wizard_Step_License_Key extends GF_Installation_Wizard_Step {
	...
	public $defaults = array(
		'license_key' => '4308eedb-1add-43a9-bbba-6f5d5aa6b8ee',
		'accept_terms' => true,
	);
	...
	function display() {
		...
		<div>
			<input type="text" class="regular-text" id="license_key" name="license_key" readonly="readonly" value="4308eedb-1add-43a9-bbba-6f5d5aa6b8ee" placeholder="4308eedb-1add-43a9-bbba-6f5d5aa6b8ee"/>
			<?php
